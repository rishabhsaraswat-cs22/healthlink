    ...
    <nav className="p-4 border-b border-gray-300">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <div className="text-gray-500 font-semibold text-sm border-2 border-gray-500 rounded-full px-3 py-1 max-sm:text-[0.6rem] max-sm:border-none">admin</div>
          <svg xmlns="http://www.w3.org/2000/svg" onClick={handleLogout} className="cursor-pointer h-6 w-6 text-red-500 font-bold" viewBox="0 0 24 24" fill="currentColor" strokeWidth="2">
